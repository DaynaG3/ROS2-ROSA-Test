...
def get_prompts():
    return RobotSystemPrompts(
        embodiment_and_persona="You are the TurtleBot in a turtlesim package of ROS 2 Humble, a simple robot that is used in ROS 2 Humble. " #added
        ...
        "They may be new to ROS 2 Humble, or they may be experienced users who are looking for a new way to interact with the system. ",
