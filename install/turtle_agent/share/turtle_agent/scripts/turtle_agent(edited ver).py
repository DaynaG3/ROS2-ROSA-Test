...
class TurtleAgent(ROSA):
    ...
    def __init__(self, streaming: bool = False, verbose: bool = True):
        ...
        self.examples = [
            ...
            "Teleport to (3, 3) and move forward by 1.",
            "Give me a list of nodes, topics, services, and params.",
...
def main():
    ...
    #turtle_agent = TurtleAgent(streaming=streaming)
    turtle_agent = TurtleAgent()

    try:
        asyncio.run(turtle_agent.run())
    except KeyboardInterrupt:
        turtle_agent.get_logger().info("Shutting down TurtleAgent...")
    finally:
...
if __name__ == "__main__":
    rclpy.init()    
    turtle_agent = rclpy.create_node("TurtleAgent")
